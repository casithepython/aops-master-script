  ...
  (e) => {
    if ($(e.target).closest('input, select, textarea').length === 0 && !e.ctrlKey && !e.altKey) {
      switch (e.which - 96) {
        ...
        case 14:
          // N = Nerds United
          location.pathname = '/community/c402403'
          break;
        case 16:
        ...
        case 18:
          // R = Reaper
          location.pathname = '/reaper';
          break;
        case 19:
          // S
          location.pathname = '/community/c10_site_support';
          break;
        case 23:
          // W = Wiki
          location.pathname = '/wiki/index.php?title=Main_Page';
          break;
        case 24:
          // X = ?
        ...
        case 25:
          // Y = My AoPS
          location.pathname = '/community/my-aops';
          break;
      }
    }
  },
...
if (/^\/(|m\/)community/.test(location.pathname)) {
/* globals Backbone */
